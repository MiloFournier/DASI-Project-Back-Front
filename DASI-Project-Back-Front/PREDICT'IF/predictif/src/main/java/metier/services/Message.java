...
public class Message {
    ...
    public static void envoyerNotification(String destinataire, String telephoneDestinataire, String message) {
        ...
        Message.debut();
        OUT.println(NOTIFICATION_COLOR + "~~~ Notification envoyée le " + HORODATE_FORMAT.format(maintenant) + " ~~~");
        OUT.println(NOTIFICATION_COLOR + "Pour : " + destinataire + ", Tel : " + telephoneDestinataire);
        OUT.println("Message : " + NOTIFICATION_COLOR + message.replace("\n", "\n" + NOTIFICATION_COLOR));
        OUT.print(RESET);
        Message.fin();
    }
